...
## 🧐 仮説と要因分析
宿泊価格に影響を与える可能性のある要因をいくつか仮定します。

### 立地条件 (city, zipcode, latitude, longitude):
- 都市（例: NYC, LA, SF）や郵便番号、緯度・経度が価格に直接影響する。
- 大都市ほど宿泊価格が高くなる傾向がある。
- 宿泊人数 (accommodates)
- 宿泊可能人数が多いほど価格が高くなると予想。

### アメニティ (amenities):
- アメニティの種類が豊富な物件は価格が高い可能性。
- 特に「キッチン」「Wi-Fi」「冷暖房」などの人気アメニティが影響。

### プロパティタイプ (property_type):
- アパートや一軒家、ゲストハウスなどの種類で価格が異なる。

### キャンセルポリシー (cancellation_policy):
- 柔軟なキャンセルポリシーの物件は需要が高く、価格が高い可能性。

### レビュー関連 (review_scores_rating, number_of_reviews):
- レビューの評価スコアや件数が価格に影響する可能性。

### 即時予約可否 (instant_bookable)
- 即時予約が可能な物件は人気が高く、価格が高くなる可能性。
